    ...
    document.addEventListener("DOMContentLoaded", function () {
        setTimeout(() => {
            // Hilangkan loading screen dengan animasi fade-out
            const loadingScreen = document.getElementById("loading-screen");
            loadingScreen.classList.add("fade-out");
    
            // Tampilkan konten utama dengan animasi fade-in
            const contentAwal = document.getElementById("content-awal-bgt");
            contentAwal.classList.remove("opacity-0");
            contentAwal.classList.add("opacity-1");
    
            // Hapus loading screen dari DOM setelah transisi selesai
